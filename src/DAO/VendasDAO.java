 ...
 * @author Mike
 */
public class VendasDAO extends ConexaoDAO {
    ...
    public int salvarVendasDAO(ModelVendas pModelVendas) {
        try {
            ...
            return this.insertSQL(
                    ...
                    + "'" + pModelVendas.getDataExecucao() + "',"
                    + "'" + pModelVendas.getHoraExecucao() + "'"
                    + ");"
            );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ModelVendas getVendasDAO(int pCodigo) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelVendas.setDataExecucao(this.getResultSet().getDate(9));
                modelVendas.setHoraExecucao(this.getResultSet().getString(10));
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
     ...
     */
    public ArrayList<ModelVendas> getListaAgendaDAO() {
        ArrayList<ModelVendas> listamodelVendas = new ArrayList();
        ModelVendas modelVendas = new ModelVendas();
        try {
            this.conectar();
