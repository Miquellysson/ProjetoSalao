...
public class ViewProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 580, 280));
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        // verifica se existe realmente alguma linha selecionada
    ...
    private void tfValorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfValorFocusLost
        ...
        this.tfValor.setText(new Mascaras().converterVirgulaParaPonto(this.tfValor.getText()));
    ...
    private void tfEstoqueFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfEstoqueFocusLost
        this.tfEstoque.setText(new Mascaras().converterVirgulaParaPonto(this.tfEstoque.getText()));
